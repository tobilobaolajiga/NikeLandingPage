...
const Hero = () => {
  ...
  return (
    <section id='home' className="w-full flex flex-col justify-center min-h-screen xl:flex-row gap-10 max-container">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-montserrrat text-slate-gray">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
